...
public class SendMoney extends AppCompatActivity implements UserCardAdapter.UserCardClickEvents{
    ...
    public void onUserClicked(UserModel userModel) {
        Intent intent=new Intent(SendMoney.this,SendMoneyAmount.class);
