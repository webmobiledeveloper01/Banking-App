...
public class AddIncome extends AppCompatActivity implements BottomSheetDateSelector.BottomSheetListener,CategoryAdapter.CategoryClickEvents{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(AddIncome.this,IncomeStatus.class);
    ...
    private void setCategories(){
        ...
        categoryModels.add(new CategoryModel("Salary",R.drawable.bill1));
        categoryModels.add(new CategoryModel("Contract Work",R.drawable.ic_work));
        categoryModels.add(new CategoryModel("Investment",R.drawable.ic_investment));
        categoryModels.add(new CategoryModel("Rental",R.drawable.rental));
        categoryModels.add(new CategoryModel("Others",R.drawable.other_income));
        ...
        txtOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currencyModel==null){
                    Toast.makeText(AddIncome.this,"Select currency",Toast.LENGTH_SHORT).show();
                }else {
