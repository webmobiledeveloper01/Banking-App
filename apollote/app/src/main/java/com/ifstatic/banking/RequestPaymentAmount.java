...
public class RequestPaymentAmount extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_request_payment_amount);
        initializeView();
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (TextUtils.isEmpty(textAmount.getText().toString())){
                    Toast.makeText(RequestPaymentAmount.this,"Enter amount",Toast.LENGTH_SHORT).show();
                }else{
                    try {
                        double amount=Double.parseDouble(textAmount.getText().toString());
                        if (amount>0){
                            Intent intent=new Intent(RequestPaymentAmount.this,RequestReview.class);
                        ...
                        e.printStackTrace();
                        Toast.makeText(RequestPaymentAmount.this,"Enter valid amount",Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        txtOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (currencyModel==null){
                    Toast.makeText(RequestPaymentAmount.this,"Select currency",Toast.LENGTH_SHORT).show();
                }else {
